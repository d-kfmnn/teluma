...
class Term {
  ...
  // /identifies whether term contains a dual variable
  unsigned dual_count = 0;
  ...
  */
  ...
  /** Getter for member dual_count

      @return integer
  */
  unsigned get_dual_count() const {return dual_count;}
...
*/
Term * multiply_term(Term * t1, Term * t2, bool dual_cut = 1);
