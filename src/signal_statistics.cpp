...
void print_statistics() {
  ...
  msg("used time for initializing:        %18.2f seconds",
      init_time);
  msg("used time for adder marking:       %18.2f seconds",
      substitution_time - init_time);
  msg("used time for slicing/elimination: %18.2f seconds",
      slicing_elim_time - substitution_time);
